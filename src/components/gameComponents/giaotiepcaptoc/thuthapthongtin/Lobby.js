...
function MonopolyLobby({ socket, room, username, setjionRoom, setStart, messageCheck }) {
  useEffect(() => {
  }, [room]);
  ...
  return (
    <div>
      ...
      <div style={{ textAlign: "left" }}>
        ...
        <p>Tất cả các câu cần dùng là:
        <br />How are you? _Xin chào.
        <br />What is your name? _Bạn bao nhiêu tuổi?
        <br />Can you spell your name? _Bạn có thể đánh vần tên của mình được không?
        <br />How old are you? _Bạn bao nhiêu tuổi?
      </p>
      </div>
      ...
      <div className="row mt-3">
        ...
        <div className="col-3 mt-3">
          <span style={{ border: "1px solid blue", borderRadius: "6px", backgroundColor: messageCheck === "create a room" ? "yellow" : "white" }} onClick={() => socket.emit("chess", ["createRoom", socket.id, getCookie("username")])}>Create a room!</span>
        </div>
      </div>
      <p className="border border-primary mt-3" />
