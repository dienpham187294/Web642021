...
function LearnChess({ socket }) {
    ...
    return (
        <Container>
            ...
            {sence
                ? <MonopolyLobby room={room} username={getCookie("username")} setjionRoom={setjionRoom} setStart={setStart} setMessageCheck={setMessageCheck} messageCheck={messageCheck} socket={socket} />
